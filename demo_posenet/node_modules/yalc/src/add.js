    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                doPure = options.pure === false ? false : options.pure;
                addedInstallsP = packages.map(function (packageName) { return __awaiter(_this, void 0, void 0, function () {
                    var _a, name, _b, version, storedPackagePath, versionToInstall, storedPackageDir, pkg, destYalcCopyDir, replacedVersion, destModulesDir, protocol, localAddress, dependencies, devDependencies, whereToAdd, binDir_1, addBinScript, name_1, addedAction, signature;
