...
exports.updatePackages = function (packages, options) { return __awaiter(_this, void 0, void 0, function () {
    var workingDir, lockfile, packagesToUpdate, installationsToRemove, lockPackages, packagesFiles, addOpts, packagesLinks, packagesLinkDep, packagesPure, _i, packages_1, packageName, pkg, postupdate;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, _1.addPackages(packagesFiles, __assign({}, addOpts, { yarn: false }))];
            case 1:
                _a.sent();
                packagesLinks = lockPackages
                    .filter(function (p) { return !p.file && !p.link && !p.pure; })
                    .map(function (p) { return p.name; });
                return [4 /*yield*/, _1.addPackages(packagesLinks, __assign({}, addOpts, { link: true, pure: false, yarn: false }))];
            case 2:
                _a.sent();
                packagesLinkDep = lockPackages.filter(function (p) { return p.link; }).map(function (p) { return p.name; });
                return [4 /*yield*/, _1.addPackages(packagesLinkDep, __assign({}, addOpts, { linkDep: true, pure: false, yarn: false }))];
            case 3:
                _a.sent();
                packagesPure = lockPackages.filter(function (p) { return p.pure; }).map(function (p) { return p.name; });
                return [4 /*yield*/, _1.addPackages(packagesPure, __assign({}, addOpts, { pure: true, yarn: false }))];
            case 4:
                _a.sent();
